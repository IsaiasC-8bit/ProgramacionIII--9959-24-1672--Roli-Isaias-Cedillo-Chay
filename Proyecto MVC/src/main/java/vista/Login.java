...
public class Login extends javax.swing.JFrame {
    ...
    private void AccesoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AccesoActionPerformed
        // TODO add your handling code here:
        Computador compu1 = new Computador("mecanico","MSI","Celeron 2","1920x1080","Graficos Integrados","ssd");
        Computador compu2 = new Computador("manual","hp","i3","1280*720","GT 1030","hdd");
        Computador compu3 = new Computador("zahora","Apple","M3","1920x1080","AM4","Nve 2.0");
        compu1.setRamCantidad(16);
        compu1.setCantidadMemoriaGB(1000);
        compu2.setRamCantidad(4);
        compu2.setCantidadMemoriaGB(500);
        compu3.setRamCantidad(32);
        compu3.setCantidadMemoriaGB(500);
        System.out.println(compu1.toString());
        System.out.println(compu2.toString());
        System.out.println(compu3.toString());
